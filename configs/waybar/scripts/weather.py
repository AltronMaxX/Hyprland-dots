...
weather = requests.get("https://wttr.in/Saratov?format=j1").json()
...
data['tooltip'] = f"<b>City: {weather['nearest_area'][0]['region'][0]['value']} Country: {weather['nearest_area'][0]['country'][0]['value']}</b>\n"
